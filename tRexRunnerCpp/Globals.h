...
#define TREX_STARTING_POSITION_Y 35

#define HORIZON_POSITION_X 0
#define HORIZON_POSITION_Y 50
...
#define TREX_DUCKING_POSITION_Y TREX_STARTING_POSITION_Y + TREX_STANDING_HEIGHT - TREX_DUCKING_HEIGHT
